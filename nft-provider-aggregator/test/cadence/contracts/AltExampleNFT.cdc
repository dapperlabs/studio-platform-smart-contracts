...
access(all) contract AltExampleNFT: NonFungibleToken {
    ...
    access(all) resource NFT: NonFungibleToken.NFT {
        ...
        access(all) fun createEmptyCollection(): @{NonFungibleToken.Collection} {
            return <-AltExampleNFT.createEmptyCollection(nftType: Type<@AltExampleNFT.NFT>())
        }
        ...
        access(all) fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return AltExampleNFT.resolveContractView(resourceType: Type<@AltExampleNFT.NFT>(), viewType: Type<MetadataViews.NFTCollectionData>())
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return AltExampleNFT.resolveContractView(resourceType: Type<@AltExampleNFT.NFT>(), viewType: Type<MetadataViews.NFTCollectionDisplay>())
                ...
                case Type<MetadataViews.EVMBridgedMetadata>():
                    ...
                    let contractLevel = AltExampleNFT.resolveContractView(
                            resourceType: nil,
    ...
    access(all) resource Collection: NonFungibleToken.Collection, ExampleNFTCollectionPublic {
        ...
        access(all) view fun getSupportedNFTTypes(): {Type: Bool} {
            ...
            supportedTypes[Type<@AltExampleNFT.NFT>()] = true
        ...
        access(all) view fun isSupportedNFTType(type: Type): Bool {
            return type == Type<@AltExampleNFT.NFT>()
        }
        ...
        access(all) fun deposit(token: @{NonFungibleToken.NFT}) {
            let token <- token as! @AltExampleNFT.NFT
            let id = token.id
            ...
            AltExampleNFT.emitNFTUpdated(authTokenRef)
        }
        ...
        switch viewType {
            case Type<MetadataViews.NFTCollectionData>():
                let collectionData = MetadataViews.NFTCollectionData(
                    ...
                    publicCollection: Type<&AltExampleNFT.Collection>(),
                    publicLinkedType: Type<&AltExampleNFT.Collection>(),
    ...
    init() {
        ...
        let collectionCap = self.account.capabilities.storage.issue<&AltExampleNFT.Collection>(self.CollectionStoragePath)
